...
class CityController extends PanelController
{
	...
	public function setup()
	{
		...
		*/
		...
		// Country => City
		if ($this->parentEntity == 'countries') {
			$this->xPanel->setRoute(config('larapen.admin.route_prefix', 'admin') . '/countries/' . $this->countryCode . '/cities');
			...
			$this->xPanel->setParentRoute(config('larapen.admin.route_prefix', 'admin') . '/countries');
			$this->xPanel->setParentEntityNameStrings(trans('admin::messages.country'), trans('admin::messages.countries'));
		}
		
		// Admin1 => City
		if ($this->parentEntity == 'admins1') {
			$this->xPanel->setRoute(config('larapen.admin.route_prefix', 'admin') . '/admins1/' . $this->admin1Code . '/cities');
			$this->xPanel->setEntityNameStrings(
			...
			$this->xPanel->setParentRoute(config('larapen.admin.route_prefix', 'admin') . '/countries/' . $this->countryCode . '/admins1');
		...
		// Admin2 => City
		if ($this->parentEntity == 'admins2') {
			$this->xPanel->setRoute(config('larapen.admin.route_prefix', 'admin') . '/admins2/' . $this->admin2Code . '/cities');
			$this->xPanel->setEntityNameStrings(
			...
			$this->xPanel->setParentRoute(config('larapen.admin.route_prefix', 'admin') . '/admins1/' . $this->admin1Code . '/admins2');
			$this->xPanel->setParentEntityNameStrings(
