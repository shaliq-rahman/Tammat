...
class AdsCleaner extends Command
{
    ...
    public function __construct()
    {
        ...
        $this->unactivatedPostsExpiration = (int)config('settings.listing.unactivated_posts_expiration', $this->unactivatedPostsExpiration);
        $this->activatedPostsExpiration = (int)config('settings.listing.activated_posts_expiration', $this->activatedPostsExpiration);
        $this->archivedPostsExpiration = (int)config('settings.listing.archived_posts_expiration', $this->archivedPostsExpiration);
    }
