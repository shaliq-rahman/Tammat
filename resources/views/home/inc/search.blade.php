...
@if (isset($sForm['enableFormAreaCustomization']) and $sForm['enableFormAreaCustomization'] == '1')
	...
	<div class="wide-intro {{ $parallax }}" style="padding-bottom: 0px;border-bottom: 1px solid #0a0a0a;max-height: 1500px;min-height: 1000px;">
...
*/ ?>
					...
					<h1 style="font-size: 24px;padding-top: 55px;color:white" class="intro-title animated fadeInDown  visible-lg"> {{ $sForm['title'] }}</h1>
					...
					@endif					 
					  ...
					  @include('home.inc.hm_categories')
