...
Tammat
	// email_verificationTammat

    'email_verification_title' => 'Verifique seu endereço de e-mail.',

    'email_verification_action' => 'Confirmar e-mail',

    'email_verification_content_1' => 'Olá :userName !',

    'email_verification_content_2' => 'Clique no botão abaixo para confirmar seu e-mail.',

    'email_verification_content_3' => 'O botão não funciona? Copie o seguinte link em seu navegador: <br><a href=":verificationLink">:verificationLink</a>.',

    'email_verification_content_4' => '<br><br>Você está recebendo este e-mail por ter criado uma nova conta Deal Not Deal ou mudou seu e-mail. Por favor ignorar  se você  não  solicitou tais alterações.',

    'email_verification_content_5' => '<br><br>Atenciosamente,<br>Equipe Deal Not Deal',
    ...
    'user_activated_title' => 'Bem-vindo ao Deal Not Deal!',
    ...
    'reset_password_content_1' => 'Esqueceu sua senha?',

    'reset_password_content_2' => 'Vamos criar uma nova.',

    'reset_password_content_3' => 'Não é necessário tomar outras medidas caso  não  tenha solicitado redefinir sua senha.',

    'reset_password_content_4' => '<br><br>Atenciosamente,<br>Deal Not Deal',

    'reset_password_content_5' => '<br><br>---<br>Se você está com dificuldades em clicar no botão "Resetar Senha", copie e cole o link abaixo em sua barra de endereços:<br> :link',
    ...
    'post_notification_content_1' => 'Olá Admin,<br><br>o utilizador acabou de publicar um anúncio.',
    ...
    'reply_form_content_1' => 'Olá,<br><br><strong>Você recebeu uma resposta de :senderName. Veja a resposta abaixo:</strong><br><br>',
