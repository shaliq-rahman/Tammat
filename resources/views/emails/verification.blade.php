    ...
    <table style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6em; width: 100%; margin: 0; padding: 0;">
        <tr style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6em; margin: 0; padding: 0;">
            <td style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 100%; line-height: 1.6em; margin: 0; padding: 0;">
                <h3 style="font-family: 'Helvetica Neue', Helvetica, Arial, 'Lucida Grande', sans-serif; font-size: 20px; line-height: 1.2em; color: #111111; font-weight: bold; margin: 0 0 10px; padding: 0;">@lang('mail.email_verification_content_1', ['userName' => $entity->{$entityRef['name']}])</h3>
                <p style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.6em; font-weight: normal; margin: 0 0 10px; padding: 0; display: inline-block; max-width: 100%; word-wrap: break-word;">@lang('mail.email_verification_content_2')</p>
                <!-- button -->
                ...
                <p style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 1.6em; font-weight: normal; margin: 0 0 10px; padding: 0; display: inline-block; max-width: 100%; word-wrap: break-word;">
					@lang('mail.email_verification_content_3', ['verificationLink' => lurl('verify/' . $entityRef['slug'] . '/email/' . $entity->email_token)])
                	@lang('mail.email_verification_content_4', ['appName' => config('app.name')])
                	@lang('mail.email_verification_content_5', ['appName' => config('app.name')])
				</p>
            </td>
        </tr>
    </table>
