								...
								<form id="signupForm" class="form-horizontal" method="POST" action="{{ url()->current() }}">
									...
									<fieldset>
										...
										<div class="form-group required <?php echo (isset($errors) and $errors->has('phone_number')) ? 'has-error' : ''; ?>">
											<label class="col-md-4 control-label">{{ t('Phone') }}<sup>*</sup>
											...
											<div class="col-md-6">
												<div class="input-group">
													...
													<input name="phone_number" placeholder="{{ t('Phone Number') }}"
														   class="form-control input-md" type="text" value="{{ phoneFormat(old('phone_number'), old('country', config('country.code'))) }}" >
                                        ...
                                        <div class="form-group required <?php echo (isset($errors) and $errors->has('city')) ? 'has-error' : ''; ?>">
											...
											<div class="col-md-6">
												<input name="city" id="city" class="form-control input-md" type="text" placeholder="{{ t('City') }}"  value="{{ old('city') }}">
											</div>
										</div>
								       ...
								       <div class="form-group required <?php echo (isset($errors) and $errors->has('user_type_id')) ? 'has-error' : ''; ?>">
											...
											<div class="col-md-6">
												<select name="user_type_id" id="userTypeId" class="form-control selecter">
													<option {{ (old('user_type_id') == '0')?'selected':'' }} value="0">
														{{ t('Select') }}
													</option>
...
@section('after_scripts')
	...
	<script>
		...
		//Auto load city Made by MonTech Team
		//var input = document.getElementById('city');
		//    var opts = {
		//		types: ['(cities)']
		//	};
