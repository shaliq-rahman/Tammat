...
// function getRelocating(postid,siteUrl) 
// {
//     if(postid != "")
//     {
//              $.ajax({
//                   type:'GET',
//                   url: siteUrl + '/getrelocating?postid='+postid,
//                   dataType: 'JSON',
//                   success:function(data){
//                         $('#where_city_date').val(data.where_city_date);
//                         $('#where_city').val(data.where_city);
//                         $('#from_city').val(data.from_city);
//                         $('#from_city_date').val(data.from_city_date);
//                         $('#from_country').val(data.from_country);
//                         $('#where_country').val(data.where_country);
//                   }
//             });
//     }
// }
