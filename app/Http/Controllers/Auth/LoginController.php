	...
	public function login_app(LoginRequest $request)
    {
       ...
       if($getusernamedetail || $getemaildetail){
           ...
           // $userData = User::find($userId);
            ...
            "about" =>$getusernamedetail->about,
            "phone" =>$getusernamedetail->phone,
            "phone_hidden" =>$getusernamedetail->phone_hidden,
            ...
            "is_admin" =>$getusernamedetail->is_admin,
            "can_be_impersonated" =>$getusernamedetail->can_be_impersonated,
            "disable_comments" =>$getusernamedetail->disable_comments,
            "receive_newsletter" =>$getusernamedetail->receive_newsletter,
            "receive_advice" =>$getusernamedetail->receive_advice,
            "ip_addr" =>$getusernamedetail->ip_addr,
            "provider" =>$getusernamedetail->provider,
            "provider_id" =>$getusernamedetail->provider_id,
