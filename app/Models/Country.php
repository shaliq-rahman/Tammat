...
class Country extends BaseModel
{
    ...
    */
    ...
    {
        $url = url(config('larapen.admin.route_prefix', 'admin') . '/countries/' . $this->id . '/edit');
	...
	{
		$url = url(config('larapen.admin.route_prefix', 'admin') . '/countries/' . $this->id . '/admins1');
	...
	{
		$url = url(config('larapen.admin.route_prefix', 'admin') . '/countries/' . $this->id . '/cities');
