...
<section class="content-header" style='margin-bottom: 20px;'>
        <h1>
            <span class="text-capitalize">Advertising Banner</span>
            <small></small>
        </h1>
        <br />
    ...
    <a href="{{url('admin/add_banner')}}" class="btn btn-primary ladda-button" data-style="zoom-in">
    ...
    foreach($advertisings_banner as $nlData) {
     ...
     ?>
      <tr>
        ...
        <td>
            <a href="{{url('admin/edit_banner/'.$nlData->id)}}" class="btn btn-primary">Edit</a>
            <a href="{{url('admin/delete_banner/'.$nlData->id)}}" class="btn btn-danger">Delete</a>
        </td>
      </tr>
<?php } } ?>      
    </tbody>
