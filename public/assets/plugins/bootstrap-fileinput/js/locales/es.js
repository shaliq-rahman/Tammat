...
(function ($) {
    ...
    $.fn.fileinputLocales['es'] = {
        ...
        msgSizeTooLarge: 'El archivo "{name}" (<b>{size} KB</b>) excede el tamaño de carga máximo permitido de <b>{maxSize} KB</b>.',
        ...
        msgInvalidFileExtension: 'Extensión inválida para el archivo "{name}". Solo se admiten archivos "{extensions}".',
        msgFileTypes: {
            'image': 'image',
            'html': 'HTML',
            'text': 'text',
        ...
        previewZoomButtonTitles: {
            prev: 'Anterior',
            next: 'Siguiente',
            toggleheader: 'Cambiar a Encabezado',
            fullscreen: 'Cambiar a Pantalla Completa',
            borderless: 'Cambiar al Modo sin Bordes',
