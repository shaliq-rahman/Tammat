...
return [
    ...
    'custom' => [
        ...
        'username' => [
            'min' => 'Le nom d\'utilisateur doit comprendre au moins 5 caractères.',
        ...
        'password' => [
            ...
            'between' => 'Le mot de passe doit comprendre entre 6 et 60 caractères.',
            'confirmed' => 'Ce mot de passe est trop commun. Choisissez-en un autre.',
        ],
        'phone_number' => [
        ...
        'term' => [
            'accepted' => 'Les Conditions Générales doivent être acceptées.',
        ],
        'city' => [
            'required' => 'Le champ ville est requis.',
        ],
        'user_type_id' => [
            'required' => 'Le type d\'utilisateur sélectionné est invalide.',
            'not_in' => 'Le type d\'utilisateur sélectionné est invalide.',
        ],
        'login' => [
            'required' => 'Le champ connexion est requis.',
        ],
        'city_name' => [
            'required' => 'Le champ ville est requis.',
        ],
        ...
        'description' => [
            ...
            'mb_between' => 'La description doit comprendre entre 5 et 6000 caractères.',
        ],
        'price' => [
