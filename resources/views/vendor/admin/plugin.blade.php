                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            @if ($plugin->has_installer)
                                @if ($plugin->installed)
                                    <a class="btn btn-xs btn-success" href="{{ url(config('larapen.admin.route_prefix', 'admin') . '/plugins/' . $plugin->name . '/uninstall') }}">
                                        <i class="fa fa-toggle-on"></i> {{ trans('admin::messages.Uninstall') }}
                                    </a>
                                @else
                                    <a class="btn btn-xs btn-default" data-button-type="delete" href="{{ url(config('larapen.admin.route_prefix', 'admin') . '/plugins/' . $plugin->name . '/install') }}">
                                        <i class="fa fa-toggle-off"></i> {{ trans('admin::messages.Install') }}
                                    </a>
                                @endif
                            @endif
                            <!--
                            <a class="btn btn-xs btn-danger" data-button-type="delete" href="{{ url(config('larapen.admin.route_prefix', 'admin') . '/plugins/' . $plugin->name . '/delete') }}">
