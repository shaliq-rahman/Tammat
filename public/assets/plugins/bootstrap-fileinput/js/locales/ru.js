...
(function ($) {
    ...
    $.fn.fileinputLocales['ru'] = {
        ...
        msgZoomModalHeading: 'Подробный предварительный просмотр',
        ...
        msgSizeTooLarge: 'Файл "{name}" (<b>{size} KB</b>) превышает допустимый размер в <b>{maxSize} KB</b>.',
        ...
        msgInvalidFileExtension: 'Неверный формат файла "{name}". Пожалуйста, используй файлы формата, "{extensions}".',
        msgFileTypes: {
            'image': 'image',
            'html': 'HTML',
            'text': 'text',
        ...
        msgUploadThreshold: 'Пожалуйста, подождите',
        ...
        dropZoneClickTitle: '<br>(или нажмите на выбранный {files})',
        fileActionSettings: {
        ...
        previewZoomButtonTitles: {
            ...
            toggleheader: 'Переключаемый заголовок',
            fullscreen: 'Полный Экран',
            borderless: 'Переключение Режима Без Границ',
            close: 'Закрыть подробный просмотр'
        }
    };
})(window.jQuery);
