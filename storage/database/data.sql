...
(75, 'en', 75, 0, 'Free Dating', 'free-dating', NULL, 'app/categories/skin-default/ion-ios-heart.png', 'icon-heart', 288, 307, 1, 'non-salable', 1),
...
INSERT INTO `<<prefix>>home_sections` (`id`, `name`, `method`, `options`, `view`, `parent_id`, `lft`, `rgt`, `depth`, `active`) VALUES(1, 'Search Form Area', 'getSearchForm', NULL, 'home.inc.search', 0, 0, 1, 1, 1);
INSERT INTO `<<prefix>>home_sections` (`id`, `name`, `method`, `options`, `view`, `parent_id`, `lft`, `rgt`, `depth`, `active`) VALUES(2, 'Locations & Country Map', 'getLocations', NULL, 'home.inc.locations', 0, 2, 3, 1, 1);
INSERT INTO `<<prefix>>home_sections` (`id`, `name`, `method`, `options`, `view`, `parent_id`, `lft`, `rgt`, `depth`, `active`) VALUES(3, 'Sponsored Ads', 'getSponsoredPosts', NULL, 'home.inc.featured', 0, 4, 5, 1, 1);
INSERT INTO `<<prefix>>home_sections` (`id`, `name`, `method`, `options`, `view`, `parent_id`, `lft`, `rgt`, `depth`, `active`) VALUES(4, 'Categories', 'getCategories', NULL, 'home.inc.categories', 0, 6, 7, 1, 1);
INSERT INTO `<<prefix>>home_sections` (`id`, `name`, `method`, `options`, `view`, `parent_id`, `lft`, `rgt`, `depth`, `active`) VALUES(5, 'Latest Ads', 'getLatestPosts', NULL, 'home.inc.latest', 0, 8, 9, 1, 1);
...
INSERT INTO `<<prefix>>home_sections` (`id`, `name`, `method`, `options`, `view`, `parent_id`, `lft`, `rgt`, `depth`, `active`) VALUES(7, 'Advertising #1', 'getTopAdvertising', NULL, 'layouts.inc.advertising.top', 0, 12, 13, 1, 0);
INSERT INTO `<<prefix>>home_sections` (`id`, `name`, `method`, `options`, `view`, `parent_id`, `lft`, `rgt`, `depth`, `active`) VALUES(8, 'Advertising #2', 'getBottomAdvertising', NULL, 'layouts.inc.advertising.bottom', 0, 14, 15, 1, 0);
