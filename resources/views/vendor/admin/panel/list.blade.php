        ...
        <div class="col-md-12">
            <div class="box box-primary">
				...
				<div class="box-header {{ $xPanel->hasAccess('create')?'with-border':'' }}">
					...
					<div class="dropdown">
                    <button onclick="myFunction()" class="dropbtn btn btn-primary">Export</button>
                    @if ($xPanel->route=='admin/users')
                    <div id="myDropdown" class="dropdown-content">
                        <a href="{{url('admin/exportxcl')}}">csv</a>
                        <a href="{{url('admin/exportexcel')}}" class="excel">Excel</a>
    
                     </div>
                     
                     	@endif
                     	
                     	   @if ($xPanel->route=='admin/custom_fields')
                    <div id="myDropdown" class="dropdown-content">
                        <a href="{{url('admin/exportxclf')}}">csv </a>
                        <a href="{{url('admin/exportexcelf')}}" class="excel">Excel</a>
    
                     </div>
                    	@endif
                     
                       @if ($xPanel->route=='admin/custom_fields/'.request()->segment(3).'/options')
                       <div id="myDropdown" class="dropdown-content">
                        <a href="{{url('admin/exportxclfo/'.request()->segment(3))}}">csv </a>
                        <a href="{{url('admin/exportexcelfo/'.request()->segment(3))}}" class="excel">Excel</a>
                     </div>
                     	...
                     	@endif
                     	 ...
                     	 @if ($xPanel->route=='admin/posts')
                    <div id="myDropdown" class="dropdown-content">
                        <a href="{{url('admin/exportxclp')}}">csv</a>
                        <a href="{{url('admin/exportexcelp')}}" class="excel">Excel</a>
                     	...
                     	@endif
                     		 ...
                     		 @if ($xPanel->route=='admin/categories')
                    <div id="myDropdown" class="dropdown-content">
                        
                        <a href="{{url('admin/exportcat')}}" class="excel">Excel</a>
                     	...
                     	@endif
                     	 ...
                     	 @if (strpos($xPanel->route, 'subcategories') !== false)
       ...
       $(".excel").click(function(){
           ...
           $.ajax({
                method: 'POST', // Type of response and matches what we said in the route
                   url: '/admin/exportexcel', // This is the url we gave in the route
                   data: {'type' : 'excel'}, // a JSON object to send back
