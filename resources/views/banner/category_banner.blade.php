...
<section class="content-header" style='margin-bottom: 20px;'>
        <h1>
            <span class="text-capitalize">Category Banner</span>
            <small></small>
        </h1>
        <br />
    ...
    <a href="{{url('admin/add_category_banner')}}" class="btn btn-primary ladda-button" data-style="zoom-in">
		<span class="ladda-label">
            <i class="fa fa-plus"></i> Category Banner
        </span>
    </a>
    ...
    foreach($advertisings_banner as $nlData) {
     ...
     ?>
      <tr>
        ...
        <td>
            <a href="{{url('admin/edit_category_banner/'.$nlData->id)}}" class="btn btn-primary">Edit</a>
            <a href="{{url('admin/delete_category_banner/'.$nlData->id)}}" class="btn btn-danger">Delete</a>
        </td>
      </tr>
<?php } } ?>      
    </tbody>
