...
<section class="content-header" style='margin-bottom: 20px;'>
   <h1>
      <span class="text-capitalize">Edit Delivery Email</span>
      <small></small>
   </h1>
</section>
<section class="content">
   <div class="row">
      <div class="col-md-8 col-md-offset-2">
         ...
         <form method="POST" action="{{url('admin/post_delivery_email_edit')}}" accept-charset="UTF-8">
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
            <div class="box box-primary">
               <div class="box-header with-border">
                  <h3 class="box-title">Edit a new  Delivery Email</h3>
               </div>
               <div class="box-body row">
                ...
                <div class="form-group col-md-6">
                    <label>Country</label>
                      ...
                      <select class="form-control select2_field" name="country_code" required disabled >
                            <option value="">Select Country</option>    
                            @foreach($countrydata as $value)
                                <?php
                                $selected = '';
                                ?>
                                @if($value->code == $delivery->country_code)
                                    <?php
                                    $selected = 'selected';
                                    ?>
                                @endif
                ...
                <div class="form-group col-md-6">
                    <label>Email</label>
                    <input class="form-control" value="<?=$delivery->email?>" required type="email" name="email">
