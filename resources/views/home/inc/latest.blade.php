      ...
      <div class="col-sm-12 page-content col-thin-left">
         ...
         <div class="category-list">
            ...
            <div class="col-lg-12 box-title no-border" style="text-align: center;background-color: #ff5555c7 ; border-radius: 40px;margin:7px;height: 70px;">
              ...
              <h1 class="title-3" style="color: #fff;padding-top: 20px;"> <p style="font-weight: bold;">{{ t('Latest Ads') }}</p></h1>
                              ...
                              <div class="add-details">
                                 ...
                                 <span class="info-row">
                                    ...
                                    <div  style="margin-left: 0px;" class="item-location">
                                       ...
                                       <a href="{!! qsurl(config('app.locale').'/'.trans('routes.v-search', ['countryCode' => config('country.icode')]), array_merge(Request::except(['l', 'location']), ['l'=>$post->city_id])) !!}" class="info-link">{{ $post->city_name }}</a> {{ (isset($post->distance)) ? '- ' . round(lengthPrecision($post->distance), 2) . unitOfLength() : '' }}
