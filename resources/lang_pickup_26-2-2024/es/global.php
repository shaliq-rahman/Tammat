...
return [
    ...
    'Show all posts' => 'Todos los Anuncios',
  ...
  'Recharge Points' => 'Recharge Points',
    ...
    'Date & Time Preference' => 'Fecha y hora de preferencia',
    ...
    'Create your account, Its free' => 'Cree su cuenta 100% Gratis',
    ...
    'Without Country Code' => 'Número de teléfono sin código de país',
    ...
    'I have read and agree to the <a :attributes>Terms & Conditions</a>' => 'He leído y acepto los <a :attributes>Términos y Condiciones</a>',

    'By continuing on this website, you accept our <a :attributes>Terms of Use</a>' => 'Al continuar en este sitio web acepta nuestros <a :attributes>términos de uso</a>',
    ...
    'Post a Free Classified' => 'Publique un Anuncio Gratis',
    ...
    'Do you have something to sell, buy, exchange or just give it away? Post it on our website, its free, for local business and very easy to use!' => '¿Tiene algo para vender, comprar, intercambiar o simplemente regalar? Publíquelo en nuestro sitio web, es gratis, para negocios locales y muy fácil de usar.',

    'Create and Manage Items' => 'Cree y Gestione sus Artículos',

    'Become a best seller or buyer. Create and Manage your ads. Repost your old ads, etc.' => 'Conviértase en el mejor comprador o vendedor. Cree y Gestione sus Anuncios. Vuelva a publicar sus anuncios viejos, etc.',

    'Create your Favorite ads list.' => 'Cree su Lista de Anuncios Favoritos.',

    'Create your Favorite ads list, and save your searches. Don\'t forget any deal!' => 'Cree su Lista de Anuncios Favoritos y Guarde su búsqueda. No se pierda de nada.',
    ...
    'Describe what makes your ad unique' => 'Describa qué hace que su anuncio sea único.',
    ...
    'Add up to :pictures_number photos. Use a real image of your product, not catalogs.' => 'Agregue hasta :pictures_number fotos. Use una imagen real de su producto, no de catálogos.',
    ...
    'Use a brief title and description of the item' => 'Use una descripción breve de lo que desea vender.',

    'Make sure you post in the correct category' => 'Asegúrese de publicar en la categoría correcta.',

    'Add nice photos to your ad' => 'Agregue fotos de calidad a su anuncio.',

    'Put a reasonable price' => 'Coloque un precio razonable.',

    'Check the item before publish' => 'Revise su artículo antes de publicar',
    ...
    'Your details account has updated successfully.' => 'Los detalles de su cuenta se han actualizado con éxito.',
    ...
    'Your ad has been created.' => 'Su anuncio ha sido creado',

    'Update My Ad' => 'Update My Ad',

    'Your ad has been updated.' => 'Su anuncio ha sido actualizado',
    ...
    'Pending approval' => 'Pendiente por Aprobación',
    ...
    'You are sure you want to close your account?' => '¿Realmente desea cerrar su cuenta?',

    'Yes' => 'Si',

    'No' => 'No',

    'count_posts' => '{0} Anuncio|{1} Anuncio|[2,*] Anuncios',
    ...
    'Oops ! An error has occurred. Please correct the red fields in the form' => 'Se ha producido un error. Por favor, corrija los campos en rojo en el formulario',
    ...
    'You last logged in at' => 'Último inicio de sesión',
    ...
    'Ad\'s Details' => 'Detalles del Anuncio',
    ...
    'Meet seller at a public place' => 'Conozcan al Vendedor en un lugar público',

    'Check the item before you buy' => 'Verifiquen el artículo antes de comprarlo',

    'Pay only after collecting the item' => 'Paguen solo al recibir el artículo',

    'Know more' => 'Saber más',

    'View phone' => 'Ver teléfono',

    'Contact advertiser' => 'Contactar al Anunciante',
    ...
    'All Ads' => 'Todas las Publicaciones',
    ...
    'Terminate Account' => 'ELIMINAR CUENTA',
    ...
    'Meanwhile, you may <a href=":url">return to homepage</a>' => 'Mientras tanto, puedes <a href=":url">regresar a la página principal</a>',
    ...
    'These credentials do not match our records.' => 'La información proporcionada no es correcta.',
    ...
    'Popular Ads' => 'Anuncios Populares',
    ...
    'Uploaded file #index successfully' => '\'<li>\' + \'Archivo cargado # \' + (index + 1) + \' - \'  + fname + \' successfully.\' + \'</li>\'',

    'Uploaded file #key successfully' => '\'<li>\' + \'Archivo cargado # \' + (key + 1) + \' - \'  + fname + \' successfully.\' + \'</li>\'',
    ...
    'Enter a city name OR a state name with the prefix ":prefix" like: :prefix' => 'Ingresa el Nombre d ela Ciudad o el Nombre del Estado con el Prefijo ":prefix" como area: :prefix',
    ...
    'An activation link has been sent to you to verify your email address.' => 'Se ha enviado un enlace de activación para verificar su dirección de correo electrónico.',
    ...
    'The activation link has been sent to you to verify your email address.' => 'Se le ha enviado un enlace de activación para verificar su dirección de correo electrónico',
    ...
    'Resend the verification message to verify your email address.' => 'Volver a enviar el mensaje de verificación para verificar su dirección de correo electrónico.',
    ...
    'Congratulation :name ! Your :field has been verified.' => 'Enhorabuena :name ! Su :field ha sido verificada.',

    'Your :field is already verified.' => 'Su :field ya está verificada.',
    ...
    'Location\'s Map' => 'Mapa de la Ubicación',
    ...
    'Add Listing' => 'Agregar Publicación',
    ...
    'No more spam/scam phone calls or emails …. Deal and Bargain online !!!' => '¡No más llamadas o correos electrónicos de Spam… ¡Haz Tratos En Línea Aquí!',

    'Minimize your waste and Maximize the prosperity of your community by giving away your unwanted items !' => 'Minimice el desperdicio y aumente la prosperidad de su comunidad. ¡Intercambie o regle sus artículos no deseados!',

    'Sign up for Newsletter' => 'Regístrese para el Boletín Informativo',

    'SignUp For Newsletter' => 'Suscríbase al Boletín de Noticias',

    'Distance within' => 'Distancia Entre',

    'To' => 'Para',

    'Show my Email on the Ad' => 'Mostrar mi Correo Electrónico al Público',

    'Show my phone number on the Ad' => 'Mostrar mi Teléfono al Público',

    'Your ad has been updated' => 'Su anuncio ha sido actualizado',

    'Select Main Category' => 'Seleccionar Categoría Principal',

    'Select Subcategory' => 'Seleccionar Categoría Secundaria',

    'Select Subcategory in' => 'Seleccionar Categoría Secundaria en',

    'Show posts with images only' => 'Publicidades solo con imágenes',
