...
return [
    ...
    'email_verification_content_4' => '<br><br>Vous recevez cet email car vous avez récemment créé un nouveau compte Tammat ou vous avez ajouté une nouvelle adresse email. Si ce n\'était pas vous, veuillez ignorer cet email.',
