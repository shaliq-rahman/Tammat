...
return [
    ...
    'custom' => [
        ...
        'category_id' => [
            'not_in' => 'Kategoria e zgjedhur është e pavlefshme.',
        ],
        'post_type_id' => [
            'not_in' => 'Kërkohet fusha e tipit.',
            'required' => 'Kërkohet fusha e tipit.',
        ],
        'title' => [
            'required' => 'Kërkohet fusha e titullit.',
        ],
        'description' => [
            'required' => 'Kërkohet fusha e përshkrimit.',
        ],
        'city_name' => [
            'required' => 'Kërkohet fusha e emrit të qytetit.',
        ],
        'parent_id' => [
            'required' => '?',
            'not_in' => '?',
