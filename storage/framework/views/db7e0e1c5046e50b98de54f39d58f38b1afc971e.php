...
if (!empty(config('country.background_image'))) {
	...
	if (\Storage::exists(config('country.background_image'))) {
		...
		$cssBuffer .= 'background-image: url(' . \Storage::url(config('country.background_image')) . getPictureVersion() . ') !important;';
...
if (!$bgImgFound) {
	...
	if (isset($searchFormOptions['background_image']) and !empty($searchFormOptions['background_image'])) {
		...
		$cssBuffer .= 'background-image: url(' . \Storage::url($searchFormOptions['background_image']) . getPictureVersion() . ') !important;';
