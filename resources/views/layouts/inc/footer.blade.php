...
<footer class="main-footer" style="">
    <div class="col-md-12" style="background: #fff;margin-bottom: 40px;padding-bottom: 10px;border-bottom: 1px solid rgba(0,0,0,.1);">
        <div style="">
            <h2 style="color: #336699;font-size: 20px;text-align: center;line-height: 35px;">
                {!! t('Minimize the waste and Maximize the prosperity of your community by giving away your unwanted items !!!') !!}
													...
													<div style="text-align: <?=(config('app.locale') == 'ar'?'left':'right')?>;" class="col-sm-12 col-xs-6 col-xxs-12 no-padding-lg  responsive-share-icon">
                    								    ...
                    								    <li>
                    								        <div style="display: inline;">
                                                                <a  style="display: inline;" class="app-icon" target="_blank" href="https://www.instagram.com/dealnotdeal/">
                                                                <img class="share-icon-size" src="https://dealnotdeal.com/images/instagram.png">
                                                                </a>
                                                            </div>
                                                            <div class="share-icon-distance" style="display: inline;">
                                                                <a  style="display: inline;" class="app-icon" target="_blank" href="https://www.facebook.com/Deal-Not-Deal-523886734765387/">
                                                                    <img  class="share-icon-size" src="https://dealnotdeal.com/images/facebook.png">
                                                                </a>
                                                            </div>
