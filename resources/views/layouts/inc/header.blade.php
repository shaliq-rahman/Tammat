...
<div class="header">
    <nav class="navbar navbar-site navbar-default" role="navigation" style="position: relative !important;">
        <div class="container">
            ...
            <div class="navbar-collapse collapse in" style="margin-top: -8px;margin-bottom: 25px;border-color: #f8f8f8; margin-left: 7%;display: contents;">
                ...
                <ul class="nav navbar-nav navbar-right" style="display: inline-block; ">
                        <li class="display-mobile-menu-home2" style="display: none; width: 50px;"  ><a href="{{ lurl('/') }}"><i class="icon-home fa"></i></a></li>
                    @if (!auth()->check())
                        ...
                        <li style="display: inline-block;  width:120px; margin-left:-20px; margin-right:-20px"><a href="{{ lurl(trans('routes.register')) }}"><i class="icon-user-add fa"></i> {{ t('Register') }}</a></li>
                ...
                <ul class="nav navbar-nav ">
                    ...
                    @if (!auth()->check())
                      ...
                      <li class="dropdown lang-menu" style="display: inline-block;">
                            <button class="btn btn-default dropdown-toggle" style="padding: 10px 12px;" type="button" data-toggle="dropdown">
                                @if(strtoupper(config('app.locale')) == 'EN')
                                English
                                @elseif(strtoupper(config('app.locale')) == 'FR')
                                 Français 
                    ...
                    @else
                     ...
                     <li class="dropdown lang-menu" style="display: inline-block;">
                            <button class="btn btn-default dropdown-toggle" style="padding: 10.45px 15px;" type="button" data-toggle="dropdown">
                                @if(strtoupper(config('app.locale')) == 'EN')
                                English
                                @elseif(strtoupper(config('app.locale')) == 'FR')
                                 Français 
