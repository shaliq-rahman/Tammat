...
<head>
    ...
    <!--stylesheet for datePicker (MonTech Team)-->
    ...
    <script>
        ...
        function saveAjaxRequest(siteUrl, el)
        {
            ...
            $.ajax({
                ...
                {
                    if (!data.resImport) {
                        alert("<?php echo trans('admin::messages.Error - You can\'t install this country.'); ?>");
                        return false;
                    }

                    if (data.isDefaultCountry == 1) {
                        alert("<?php echo trans('admin::messages.You can not disable the default country'); ?>");
                        return false;
                    }
                ...
                */
                ...
                alert("<?php echo trans('admin::messages.Error!'); ?>");
	...
	<script>
		$(document).ready(function () {
			...
			* Code made by Montech Team
			Script for User edit profile*/
			 $("#user_dob_field input").datepicker({dateFormat: 'yy-mm-dd' });
		});
	</script>
