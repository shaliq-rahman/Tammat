...
(function ($) {
    ...
    $.fn.fileinputLocales['sq'] = {
        ...
        msgPlaceholder: '{files} shfleto...',
        msgZoomModalHeading: 'ausführliche Vorschau',
        msgFileRequired: 'Sie müssen eine Datei zum Hochladen shfleto.',
        ...
        msgFilesTooLess: 'Sie müssen mindestens <b>{n}</b> {files} zum Hochladen shfleto.',
        ...
        dropZoneTitle: 'drag & drop fotografi këtu &hellip;',
        dropZoneClickTitle: '<br>(ose kliko për të zgjedhur {files} skedarët)',
        fileActionSettings: {
