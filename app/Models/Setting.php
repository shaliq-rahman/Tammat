...

{
	...
	*/
...

	{
		...
		$url = url(config('larapen.admin.route_prefix', 'admin') . '/settings/' . $this->id . '/edit');
		...
		if (!empty($value)) {
			...
			if ($this->key == 'listing') {
				...
				if (!isset($value['search_distance_default'])) {
					...
					$value['search_distance_default'] = '300';
	...
	*/
	...
	{"name":"start_user_points","label":"Start User Points","type":"text","wrapperAttributes":{"class":"form-group col-md-6"}},
	...
	{"name":"search_distance_max","label":"Max Search Distance","type":"select2_from_array","options":{"100000":"100000","10000":"10000","9000":"9000","8000":"8000","7000":"7000","6000":"6000","5000":"5000","4000":"4000","3000":"3000","2000":"2000","1000":"1000","900":"900","800":"800","700":"700","600":"600","500":"500","400":"400","300":"300","200":"200","100":"100","50":"50","0":"0"},"hint":"Max search radius distance (in km or miles)","wrapperAttributes":{"class":"form-group col-md-6"}},

	{"name":"separator_3","type":"custom_html","value":"<div style=\"clear: both;\"></div>"},

	{"name":"search_distance_default","label":"Default Search Distance","type":"select2_from_array","options":{"10000":"10000","9000":"9000","8000":"8000","7000":"7000","6000":"6000","5000":"5000","4000":"4000","3000":"3000","2000":"2000","1000":"1000","900":"900","800":"800","700":"700","600":"600","500":"500","400":"400","300":"300","200":"200","100":"100","50":"50","25":"25","20":"20","10":"10","0":"0"},"hint":"Default search radius distance (in km or miles)","wrapperAttributes":{"class":"form-group col-md-6"}},
	...
	{"name":"separator_1","type":"custom_html","value":"<hr>"}
			...
			$value = preg_replace('/"disk":"[^"]*"/', '"disk":"public"', $value);
	...
	{"name":"google_plus_url","label":"Instagram URL","type":"text"},
	...
	{"name":"separator_1","type":"custom_html","value":"<h3>Alerts Boxes (Cookie Consent, Tips, etc.)</h3>"},
	...
	{"name":"separator_4","type":"custom_html","value":"<h3>Number Format</h3>"},

	{"name":"decimals_superscript","label":"Decimals Superscript","type":"checkbox"},

	

	{"name":"separator_5","type":"custom_html","value":"<h3>Optimization</h3>"},
	...
	{"name":"separator_6","type":"custom_html","value":"<h3>JavaScript (in the &lt;head&gt; section)</h3>"},
	...
	{"name":"separator_2_2","type":"custom_html","value":"<a href=\"#admin#/actions/call_ads_cleaner_command\" class=\"btn btn-primary\"><i class=\"fa fa-play-circle-o\"></i> Run Manually</a>"}
