...
function isFromApi()
{
    ...
    if (
        ...
        && str_contains(\Route::currentRouteAction(), 'App\Plugins\api')
    ) {
...
{
    $currencyArray = array('USD' => '&#36;', 'EUR' => '&#8364;', 'GBP' => '&#163;');
    return $currencyArray;
}

function getCurrencyAmount($currency = null, $value = null)
{
    if (!empty($currency)) {
