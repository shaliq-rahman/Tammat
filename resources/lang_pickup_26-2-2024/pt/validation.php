...
return [
    ...
    'custom' => [
        ...
        'first_name' => [
            'required' => 'É necessário digitar seu primeiro nome.',
        ],
        'last_name' => [
            'required' => 'É necessário digitar seu sobrenome.',
        ],
        'user_type_id' => [
            'required' => 'O tipo de usuário  selecionado é invalido.',
            'not_in' => 'O tipo de usuário  selecionado é invalido.',
        ],
        'username' => [
            'min' => 'Digite um nome de usuário de no mínimo 5 caracteres',
            'required' => 'É necessário preencher  o campo de usuário.',
        ],
        'email' => [
            'unique' => 'Alguém já está usando este e-mail.',
            'required' => 'É necessário preencher o campo de email.',
        ],
        'password' => [
            'required' => 'É necessário preencher o  campo de  senha.',
            'between' => 'Senha entre 6 e 60 caracteres.',
            'confirmed' => 'Senha muito comum. Por favor tenta outra!',
        ],
        'phone_number' => [
            'required' => 'É necessário digital o número de seu telefone.',
            'unique' => 'Número de telefone já em uso.',
        ],
        'term' => [
            'accepted' => 'É necessário ativar os Termos e Condições',
        ],
        'city' => [
            'required' => 'É necessário digitar o nome da sua cidade.',
        ],
       'title' => [
            'required' => 'É necessário escrever o título de seu anúncio',
        ],
        'description' => [
            'required' => 'É necessário descrever seu produto',
            'mb_between' => 'Sua descrição deve conter  entre 5 e 6000 caracteres',
        ],
    ],
    'attributes' => [
        'gender' => 'gender',
