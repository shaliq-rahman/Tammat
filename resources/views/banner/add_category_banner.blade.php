...
<section class="content-header" style='margin-bottom: 20px;'>
   <h1>
      <span class="text-capitalize">Add Category Banner</span>
      <small></small>
   </h1>
</section>
<section class="content">
   <div class="row">
      <div class="col-md-8 col-md-offset-2">
         <!-- Default box -->
         <a href="{{url('admin/category_banner')}}"><i class="fa fa-angle-double-left"></i> Back to all category <span class="text-lowercase">banner</span></a><br><br>
         <form  enctype="multipart/form-data"  method="POST" action="{{url('admin/post_category_banner')}}" accept-charset="UTF-8">
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
            <div class="box box-primary">
               <div class="box-header with-border">
                  <h3 class="box-title">Add a new Category Banner</h3>
               </div>
               ...
               <div class="box-footer">
                  <div id="saveActions" class="form-group">
                     ...
                     <a href="{{url('admin/category_banner')}}" class="btn btn-default"><span class="fa fa-ban"></span> &nbsp;Cancel</a>
                  </div>
               </div>
               <!-- /.box-footer-->
            </div>
