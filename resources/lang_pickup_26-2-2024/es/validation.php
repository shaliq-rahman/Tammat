...
return [
    ...
    'dumbpwd' => 'Esta contraseña es demasiado común. Por favor, intente otra',
    ...
    'custom' => [
        ...
        'password' => [
            ...
            'between' => 'La contraseña debe tener entre 6 y 60 caracteres.',
            'confirmed' => 'La confirmación de la contraseña no coincide.',
            'dumbpwd' => 'Esta contraseña es demasiado común. Intente con otra.',
        ],
        'user_type_id' => [
            'not_in' => 'El Tipo de Usuario seleccionado no es válido',
        ],
        'first_name' => [
        ...
        'username' => [
            ...
            'valid_username' => 'El nombre de usuario solo debe tener cadenas de caracteres.',
            'between' => 'El nombre de usuario debe tener entre 3 y 100 caracteres.',
            'min' => 'El nombre de usuario debe tener al menos 5 caracteres.',
        ],
        'phone_number' => [
            'required' => 'El Teléfono es Obligatorio',
            'unique' => 'El teléfono ya ha sido tomado.',
        ],
        'city' => [
        ...
        'description' => [
            ...
            'mb_between' => 'La descripción debe tener entre 5 y 6000 caracteres.',
        ],
        'city_name' => [
        ...
        'email' => [
            ...
            'unique' => 'La dirección de correo electrónico ya ha sido tomada.',
        ],
        'term' => [
