									...
									<div class="panel-body">
										<form name="details" class="form-horizontal" role="form" method="POST" action="{{ url()->current() }}">
                                            ...
                                            <div class="form-group required <?php echo (isset($errors) and $errors->has('phone_number')) ? 'has-error' : ''; ?>">
                                                <label for="phone_number" class="col-sm-3 control-label">{{ t('Phone') }} <sup>*</sup></label>
                                            		<div class="col-sm-9">
                                            			<div class="input-group">
                                            				<span id="phoneCountry" class="input-group-addon">{!! getPhoneIcon(old('country_code', $user->country_code)) !!}</span>
                                            					...
                                            					<label class="input-group-addon" style="display:none">
                                            					    <input name="phone_hidden" id="phoneHidden" type="checkbox" value="1" {{ (old('phone_hidden', $user->phone_hidden)=='1') ? 'checked="checked"' : '' }}> {{ t('Hide') }}
                                            					</label>
                                            		</div>
                                            	</div>
											</div>
