				...
				<div class="category-list">
					<div class="tab-box">
					  <ul class="nav nav-tabs tabs-center">
					    <li class="active"><a data-toggle="tab" href="#latest">Latest Ads</a></li>
					    <li><a data-toggle="tab" href="#popular">Popular Ads</a></li>
					  </ul>
					</div>	  
				      	...
				      	<div class="col-lg-12 content-box layout-section">
							<div class="row row-featured row-featured-category">
								<div class="col-lg-12 box-title no-border">
									<div class="inner">
										<h2>
											<span class="title-3">Popular <span style="font-weight: bold;">Ads</span></span>
											<?php $attr = ['countryCode' => config('country.icode')]; ?>
											<a href="{{ lurl(trans('routes.v-search', $attr), $attr) }}" class="sell-your-item">
												{{ t('View more') }} <i class="icon-th-list"></i>
											</a>
