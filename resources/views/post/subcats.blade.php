			...
			<div class="row">
				...
				<div class="col-md-12 page-content">
					<div class="inner-box category-content">
						...
						{{ t('Select Sub Category in') }} {{ !empty($catt->name)?$catt->name:'' }}
						</strong></h2>
						<div class="row">
							<div class="col-sm-12">
				...
				@if (isset($catss) )
						@foreach($catss as $key => $cat)
							<div class="col-lg-4 col-md-3 col-sm-3 col-xs-4 f-category">
...
?>
								...
								@else
                                    	...
                                    	<a href="/{{config('app.locale')}}/category/{{ !empty($catt->slug)?$catt->slug:'' }}/{{$cat->slug}}">
    				                
    		                        @endif  
								
								
								<!--<a href="/{{config('app.locale')}}/category/{{ !empty($catt->slug)?$catt->slug:'' }}/{{$cat->slug}}?cat={{ !empty($catt->name)?$catt->name:'' }}">-->
