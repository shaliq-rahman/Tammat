...
class Language extends BaseModel
{
	...
	*/
	 ...
	 * @return string
	 */
	public function syncLanguageFilesLinesBtn($xPanel = false)
	{
		$url = url(config('larapen.admin.route_prefix', 'admin') . '/actions/sync_languages_files');
		...
		// Button
		$out = '';
		$out .= '<a class="btn btn-default" href="' . $url . '"' . $tooltip . '>';
