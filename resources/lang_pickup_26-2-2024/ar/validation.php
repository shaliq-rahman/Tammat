...
return [
	...
	'alpha_dash' => 'يجب أن لا يحتوي :attribute على مسافات',
    ...
    'custom' => [
        ...
        'post_type_id' => [
            'required' => 'لم يتم تحديد نوع البائع',
        ],
        'category_id' => [
            'not_in' => 'لم يتم اختيار الفرعية',
        ],
        'parent_id' => [
            'not_in' => 'لم يتم اختيار الفئة',
        ],
        'first_name' => [
            'required' => 'الاسم الأول',
        ],
        'last_name' => [
            'required' => 'الاسم الأخير',
        ],
        'username' => [
        ...
        'title' => [
            'required' => 'عنوان الإعلان',
        ],
        'description' => [
            'required' => 'وصف الإعلان',
        ],
        'city_name' => [
            'required' => 'المدينة',
        ],
