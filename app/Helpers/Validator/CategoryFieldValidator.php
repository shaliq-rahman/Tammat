...
class CategoryFieldValidator
{
	 ...
	 * @return bool
	 */
    public function isUnique($attribute, $value, $parameters)
    {
	 ...
	 * @return bool
	 */
	public function isUniqueWithParent($attribute, $value, $parameters)
    {
	 ...
	 * @return bool
	 */
	public function isUniqueWithChildren($attribute, $value, $parameters)
	{
		$categoryId = ($attribute == 'category_id') ? $value : $parameters[1];
